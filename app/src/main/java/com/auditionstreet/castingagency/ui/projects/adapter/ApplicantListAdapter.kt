...
class ApplicantListAdapter(
    ...
    val DIFF_CALLBACK = object : DiffUtil.ItemCallback<MyProjectDetailResponse.Data.ProjectRequests>() {

        override fun areItemsTheSame(
            oldItem: MyProjectDetailResponse.Data.ProjectRequests,
            newItem: MyProjectDetailResponse.Data.ProjectRequests
        ): Boolean {
            ...
            is ConnectionHolder -> {
             ...
             //     mCallback.invoke(position)
              //  }
                ...
                if(differ.currentList[position].artistImage.isNotEmpty()) {
                    Glide.with(mContext).load(differ.currentList[position].artistImage)
...
//                holder.bind(differ.currentList[position])
    ...
    fun submitList(projectResponse: ArrayList<MyProjectDetailResponse.Data.ProjectRequests>) {
    ...
    class ConnectionHolder(
        ...
        fun bind(item: MyProjectDetailResponse.Data.ProjectRequests) = with(itemView) {
            val rnd = Random()
